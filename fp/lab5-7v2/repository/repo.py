...
class PersonsRepository(GeneralRepository):
    ...
    def readFromFile(self):
        '''
            Description:
        '''
        my_file = open("filerepository/person_repository.txt", "r")
        string = my_file.read()
        my_file.close()
        dictionary = json.loads(string)
        for i in dictionary:
            aPerson = Persons(i["personID"], i["name"], i["phone_number"], i["address"])
    ...
    def writeToFile(self):
        '''
            Description:
        '''
        my_file = open("filerepository/person_repository.txt", "w")
...
class ActivityRepository(GeneralRepository):
    ...
    def readFromFile(self):
        '''
            Description:
        '''
        my_file = open("filerepository/activity_repository.txt", "r")
        string = my_file.read()
        my_file.close()
        dictionary = json.loads(string)
        for i in dictionary:
            aActivity = Activities(i["ID"], i["date"], i["time"], i["description"])
            self.addActivity(aActivity)
        return (1)
    ...
    def writeToFile(self):
        '''
            Description:
        '''
        my_file = open("filerepository/activity_repository.txt", "w")
        string = json.dumps(self._list, default=lambda o: o.__dict__, sort_keys=True, indent=4)
        my_file.write(string)
        my_file.close()
        return (1)
...
class mapRepository(object):
    ...
    def readFromFile(self, pers_list):
        '''
            Description:
        '''
        my_file = open("filerepository/map_repository.txt", "r")
        string = my_file.read()
        ...
        for i in new_dict:
            for j in pers_list:
                if (j.personID == int(i)):
                    aPerson = j
            aux = new_dict[i][0]
            aActivity = Activities(aux["ID"], aux["date"], aux["time"], aux["description"])
            self.addmap(aPerson, aActivity)
        return (1)
    ...
    def writeToFile(self):
        '''
            Description:
        '''
        my_file = open("filerepository/map_repository.txt", "w")
        new_dict = {}
        for i in self._map:
            new_dict[i.personID] = self._map[i]
        string = json.dumps(new_dict, default=lambda o: o.__dict__, sort_keys=True, indent=4)
        my_file.write(string)
        my_file.close()
        return (1)
